...
class SETTINGS {
  static const title = 'Retail Beats Academy';
  static const url = 'https://retailbeatsacademy.eu/'; // test dev
  static const allowedOrigins = ["innform.io", "retailbeatsacademy.eu"];
